...
const modelsConfig = [
  ...
  { id: 1, name: 'Model 2', path: 'models/m2/scene.gltf', position: [0.0, -0.1, 0.0], rotation: [0.0, -2.3, 0.0], scale: 0.001 },
  { id: 2, name: 'Model 3', path: 'models/m3/scene.gltf', position: [-1.5, -0.7, -0.5], rotation: [0.0, -1.5, 0.0], scale: 0.14 },
  boomBoxBoy,
