...
const modelsConfig = [
  ...
  { id: 1, name: 'Model 2', path: 'models/m2/scene.gltf', position: [-0.8, -1.0, 0.0], rotation: [0.0, 1.0, 0.0], scale: 0.001 },
  { id: 2, name: 'Model 3', path: 'models/m3/scene.gltf', position: [-0.8, -1.4, 0.0], rotation: [0.0, -1.4, 0.0], scale: 0.18 },
  boomBoxBoy,
