...
const modelsConfig = [
  { id: 0, name: 'Model 1', path: 'models/m1/scene.gltf', position: [-1.0, -1.0, 0.3], rotation: [0.0, 0.0, 0.0], scale: 0.2 },
  ...
  { id: 5, name: 'Model 6', path: 'models/m6/scene.gltf', position: [0.0, 0.0, 0.0], rotation: [0.0, 0.0, 2.0], scale: 0.07 },
];
