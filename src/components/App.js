...
const models = [
  {id: 0, name: "Model 1", path : "models/m1/scene.gltf", position : [0.0, 0.0, 0.0], rotation : [0.0, 0.0, 0.0], scale : 0.1},
  {id: 1, name: "Model 2", path : "models/m2/scene.gltf", position : [0.0, 0.0, 0.0], rotation : [0.0, 0.0, 0.0], scale : 0.5},
  {id: 2, name: "Model 3", path : "models/m3/scene.gltf", position : [0.0, 0.0, 0.0], rotation : [0.0, 0.0, 0.0], scale : 0.1},
  {id: 6, name: "Model 4", path : "models/m4/scene.gltf", position : [0.0, 0.0, 0.0], rotation : [0.0, Math.PI, 0.0], scale : 1.0},
  {id: 4, name: "Model 5", path : "models/m5/scene.gltf", position : [0.0, 0.0, 0.0], rotation : [0.0, 0.0, 0.0], scale : 0.05},
